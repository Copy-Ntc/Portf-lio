...
- **HTML5** semântico
- **CSS3** — variáveis nativas (custom properties), Grid, Flexbox, animações
- **JavaScript** puro (vanilla) — sem dependências externas
- **Google Fonts** — Inter e JetBrains Mono

Recursos implementados:
- Totalmente responsivo (mobile-first em pontos críticos)
- Animações de entrada com `IntersectionObserver`
- Navbar fixa com destaque de seção ativa durante a rolagem
- Efeito de digitação (typing effect) no cartão de perfil
- Acessibilidade: navegação por teclado, `aria-label`, respeito a `prefers-reduced-motion`
...
Feito por José Leandro de Siqueira Junior.
